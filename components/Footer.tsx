export default function Footer() {
    return (
        <footer className="py-16 px-4 text-center text-slate-700 bg-gradient-to-b from-[#dbeafe] via-[#e0f2fe] to-[#f0f9ff]">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <p className="text-base">1287 Maplewood Drive, Los Angeles, CA 90026</p>
